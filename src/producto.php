...
class Producto{
 ...
 public function registrar($_params){
        $sql = "INSERT INTO `productos`(`Nombre_Prod`, `categoria_id`, `Imagen`, `Precio`, `Descripcion`) 
        VALUES (:Nombre_Prod,:categoria_id,:Imagen,:Precio,:Descripcion)";
    ...
    public function actualizar($_params){
		  ...
		  `Nombre_Prod`=:Nombre_Prod,`categoria_id`=:categoria_id,`Precio`=:Precio,`Descripcion`=:Descripcion,`categoria_id`=:categoria_id  WHERE `id`=:id";
    ...
    public function mostrar(){
        $sql = "SELECT productos.id, Nombre_Prod, Imagen,Precio,Descripcion,Estado FROM productos
